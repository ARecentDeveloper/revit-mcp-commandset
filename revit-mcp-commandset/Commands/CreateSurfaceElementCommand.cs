    ...
    public class CreateSurfaceElementCommand : ExternalEventCommandBase
    {
        ...
        public override object Execute(JObject parameters, string requestId)
        {
            try
            {
                ...
                // Set surface-based component parameters
                ...
                {
                    throw new TimeoutException("Surface-based component creation operation timed out");
                }
            }
            catch (Exception ex)
            {
                throw new Exception($"Surface-based component creation failed: {ex.Message}");
            }
        }
    }
}
