    ...
    public class OperateElementEventHandler : IExternalEventHandler, IWaitableExternalEventHandler
    {
        ...
        public void Execute(UIApplication uiapp)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"Error operating elements: {ex.Message}",
                };
            }
            finally
            {
        ...
        /// <summary>
        /// Execute corresponding element operations based on operation settings
        /// </summary>
        ...
        public static bool ExecuteElementOperation(UIDocument uidoc, OperationSetting setting)
        {
            ...
            switch (action)
            {
                ...
                case ElementOperationType.SelectionBox:
                    ...
                    {
                        // If current view is 3D view, create section box in current view
                        targetView = doc.ActiveView as View3D;
                    }
                    else
                    {
                        // If current view is not 3D view, find default 3D view
                        ...
                        if (targetView == null)
                        {
                            ...
                            throw new Exception("Cannot find suitable 3D view for creating section box");
                        }
                    ...
                    // Increase bounding box size to make it slightly larger than elements
        ...
        /// <summary>
        /// Set specified elements to specified color in view
        /// </summary>
        /// <param name="doc">Document</param>
        /// <param name="elementIds">Collection of element IDs to set color</param>
