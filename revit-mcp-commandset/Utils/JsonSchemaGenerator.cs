...
namespace RevitMCPCommandSet.Utils
{
    public static class JsonSchemaGenerator
    {
        ...
        public static string GenerateTransformedSchema<T>(string mainPropertyName, bool includeThinkingProcess)
        {
            ...
            // If ThinkingProcess property needs to be added
        ...
        private static JObject GenerateSchema(Type type)
        {
            ...
            // Handle Dictionary type with priority
        ...
        /// <summary>
        /// Specifically handle Dictionary&lt;string, TValue&gt; type, ensure keys are string type, and correctly handle value types
        /// </summary>
        ...
        /// <summary>
        /// Recursively add "additionalProperties": false to objects containing "required" property
        /// </summary>
